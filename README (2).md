...
.
├── data/
│   └── README.md                 # Como obter o dataset sem versionar dados brutos
├── notebooks/
...
Depois, baixe o arquivo `master.csv` conforme as instruções em [`data/README.md`](data/README.md), salve-o em `data/master.csv` e abra o notebook:
...
O dataset utilizado é o **Suicide Rates Overview 1985 to 2016**, disponibilizado por Russell Yates no Kaggle [1]. Consulte [`data/README.md`](data/README.md) para instruções de obtenção e observações sobre o uso dos dados.
